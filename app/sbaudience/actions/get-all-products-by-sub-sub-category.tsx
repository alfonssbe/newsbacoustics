import { AllProductsForHome, CachedAllProducts, Products, Size, Specifications } from "@/app/(sbacoustics)/types";
import { redirect } from "next/navigation";

const API=`${process.env.NEXT_PUBLIC_ROOT_URL}/${process.env.NEXT_PUBLIC_FETCH_ALL_PRODUCTS_BY_SUB_SUB_CATEGORY}`;

const getAllProductsBySubSubCategory = async (path: string, subcategory: string, subsubcategory: string): Promise<CachedAllProducts> => {
