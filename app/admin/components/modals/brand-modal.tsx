...
import { Form, FormControl, FormDescription, FormField, FormItem, FormLabel, FormMessage } from "@/app/admin/components/ui/form";
...
export const BrandModal = () => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      setLoading(true);
      const response = await axios.post(`${process.env.NEXT_PUBLIC_ADMIN_FOLDER_URL}/api/brands`, values);
